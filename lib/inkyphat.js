/*jshint esversion: 6*/
let InkyphatSpi = require('./inkyphatSpi');
(function() {
  "use strict";
  ...
  class Inkyphat {
    ...
    constructor() {
      ...
      this.LIGHT_RED = InkyphatSpi.LIGHT_RED;
      this.RED = InkyphatSpi.RED;

      this.profiles = InkyphatSpi.profiles;
    ...
    redraw() {
      return inkyphatSpi.redraw(this._buffer, this._profile);
    }
