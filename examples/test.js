...
(function() {
  ...
  inkyphat.init().then(function() {
    ...
    // inkyphat.setProfile(inkyphat.profiles.quick);
    // inkyphat.setProfile(inkyphat.profiles.pimoroni);
    // inkyphat.setProfile(inkyphat.profiles.noFlash);
    // inkyphat.setProfile(inkyphat.profiles.clear);
